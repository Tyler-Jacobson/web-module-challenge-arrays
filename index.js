...
console.log("Task 4:", getFlavorByIndex(originalFlavors, 2)); // <-- Choose index here
...
emptyArray = [];
function copy(originalFlavors, originalFlavorsCopy){
    originalFlavorsCopy = [...originalFlavors];
    return originalFlavorsCopy;
}
console.log("Task 6:");
console.log(copy(originalFlavors, emptyArray));
